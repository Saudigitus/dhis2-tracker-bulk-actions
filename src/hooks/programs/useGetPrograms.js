...
export const useGetPrograms = (type, fields = "id~rename(value),displayName~rename(label),displayIncidentDate,incidentDateLabel,enrollmentDateLabel,organisationUnits,programStages[id~rename(code),repeatable,displayName~rename(label)],trackedEntityType[id,name,trackedEntityTypeAttributes[trackedEntityAttribute[displayName,id]]]") => {
