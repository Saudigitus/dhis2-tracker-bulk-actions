...
export function get2AttributeTei(tei, program) {
    const id1 = program.trackedEntityType?.trackedEntityTypeAttributes?.[0]?.trackedEntityAttribute?.id || program.programTrackedEntityAttributes?.[0]?.trackedEntityAttribute?.id || "Variable not difined"
    ...
    const id2 = program.trackedEntityType?.trackedEntityTypeAttributes?.[1]?.trackedEntityAttribute?.id || program.programTrackedEntityAttributes?.[1]?.trackedEntityAttribute?.id || "Variable not difined"
