...
function TransferComponent({ singleSelection = true, filterable = false, optionsWidth = "350px", selectedWidth = "350px", loading = false, onChange,
    options = [
        {
            label: 'ANC 1st visit',
            value: 'anc_1st_visit'
    ...
    return (
        <Transfer
            ...
            loading={loading}
            maxSelections={singleSelection && 1}
            onChange={onChange}
            options={options}
        />
    )
